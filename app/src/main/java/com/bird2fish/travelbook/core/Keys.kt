...
object Keys {
    ...
    // application name
    const val APPLICATION_NAME: String = "Travelbook"
    ...
    const val TRAVALBOOK_LEGACY_FILE_EXTENSION: String = ".trackbook"
    const val TRACK_FILE_EXTENSION: String = ".json"
    ...
    const val DEFAULT_LATITUDE: Double = 39.908710                              // latitude Nordkapp, Norway
    const val DEFAULT_LONGITUDE: Double = 116.397499                            // longitude Nordkapp, Norway
